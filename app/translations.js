...
const translations = {
  ...
  de: {
    ...
    'add-via-duration-button-label': 'Aufenthaltszeit für Zwischenstopp setzen',
    address: 'Adresse',
    ...
    'canceled-itineraries-amount':
      'Weitere {itineraryAmount, plural, =1 {1 ausgefallene Verbindung} other {{itineraryAmount} ausgefallene Verbindungen}}',
    'canceled-itineraries-amount-hide':
      'Ausgefallene Verbindungen ({itineraryAmount}) ausblenden',
    'canceled-legs': 'Ausgefallene Abfahrten auf dieser Verbindung',
    car: 'Auto',
    ...
    'fetch-new-route': 'Neue Verbindung laden',
    'footer-faq': 'FAQ',
    ...
    'itinerary-page.show-details': 'Details anzeigen',
    ...
    'rent-scooter-at': 'Scooter bei {station} mieten',
    'required-ticket': 'Benötigtes Ticket',
    'return-cycle-to': 'Fahrrad an Station {station} zurückgeben',
    'return-scooter-to': 'Scooter an Station {station} zurückgeben',
    'right-now': 'Jetzt',
    route: 'Linie',
    ...
    run: 'Schnell',
    save: 'Speichern',
    'scooter-availability': 'Scooter sind an dieser Station verfügbar',
    'scooter-availability-short': 'Scooter',
    'scooter-distance-duration': 'Scooter {distance} ({duration}) fahren',
    'scooter-register-required': 'Anmeldung beim Scooter-Anbieter benötigt',
    'scooterwalk-distance-duration': 'Scooter {distance} ({duration}) schieben',
    search: 'Ziel',
    ...
    'swap-order-button-label': 'Abfahrts- und Zielort tauschen',
    'terminal-page.description': 'Terminal - {name}',
    'terminal-page.title': 'Terminal',
    'terminal-page.title-short': 'Terminal - {name}',
